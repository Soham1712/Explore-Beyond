...
st.markdown(
    f'<h1 style="color:#FFFFFF;font-size:48px;">{"EXPLORE BEYOND"}</h1>',
...
upload = st.file_uploader("Upload your Satellite Images", type=["jpg", "png", "jpeg"])
...
model = keras.models.load_model(r"./models/cnn3.h5")
